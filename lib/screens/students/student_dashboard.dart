...
class _StudentDashboardState extends State<StudentDashboard> {
  ...
  Future<void> _load() async {
    ...
    classes = await classService.getStudentClasses(studentId);
          ...
          : ListView.builder(
              ...
              itemBuilder: (_, i) {
                ...
                return FutureBuilder<int>(
                  future: participationService.getStudentPointsForClass(
                    classId: cls['id'],
                  ),
                  builder: (_, snap) {
